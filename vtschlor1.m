ctd = load('Ramses_Deployment7_CTD_L1.mat');
eco = load('Ramses_Deployment7_ECO_L1.mat');
salini = interp1(ctd.ptime_datenum, ctd.salinCorrected, eco.ptime_datenum);
...
imon=str2num(datestr(ctd.ptime_datenum(1),'mm'));

figure;

set(gcf,'visible','on','renderer','painter');
h1=cplot(salini,tempi,baseCDOM);
hold on;
...
% export_fig ('/Users/victornguyen/Documents/MATLAB/Ramses/Ramses Salinity vs Temperature/R7STcbase.png', '-m3', '-nocrop');
